...
return [
    ...
    */
    'bots'                         => [
        'mybot' => [
            'username'            => 'UkraineSaveBot',
            'token'               => env('TELEGRAM_BOT_TOKEN', '5202270428:AAHN1iCNFiSQC8lSQsh5yhHYQL8vOheQtVU'),
            'certificate_path'    => env('TELEGRAM_CERTIFICATE_PATH', 'YOUR-CERTIFICATE-PATH'),
            'webhook_url'         => env('TELEGRAM_WEBHOOK_URL', 'https://dev-bot527.dudka.agency/tg'),
            'commands'            => [
